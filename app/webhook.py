...
_RULES_TEXT = (
    ...
    "  * Front cluster (top K close, big drop after Kth) — top K\n"
    "    share a bonus pool weighted by 1/time. K = 4/3/2 with a\n"
    "    pool of 1.5/1.5/1.0 pts respectively. Largest cluster\n"
    "    that fits wins.\n"
